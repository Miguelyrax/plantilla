...
class CourseSeeder extends Seeder
{
    ...
    public function run()
    {
       $courses = Course::factory(40)->create(); //rescato la coleccion en la variable php , todos los valores de abajo, son valores dados dinamicamente, ya que son claves foraneas

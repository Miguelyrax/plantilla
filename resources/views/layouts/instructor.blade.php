            ...
            <div class="container py-8 grid grid-cols-5">
                ...
                <aside>
                    ...
                    <ul class="text-sm text-gray-600">
                        <li class="leading-7 mb-1 border-l-4 @routeIs('instructor.courses.edit', $course) border-indigo-400 @else border-transparent  @endif pl-2"> {{--Comprueba si nos encontramos en la ruta actual--}}

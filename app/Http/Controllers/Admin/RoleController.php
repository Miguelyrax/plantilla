...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info','El rol ha sido creado');
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        $role->permissions()->sync($request->permissions); //sync elimina todos los registros de un objeto y luego crea los que trae
